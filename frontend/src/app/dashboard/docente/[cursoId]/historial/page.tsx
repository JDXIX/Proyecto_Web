...
export default function HistorialGeneralDocentePage({ params }: { params: { cursoId: string } }) {
      ...
      <div className="max-w-6xl mx-auto bg-white rounded-xl shadow p-8">
        ...
        {loading ? (
          ...
          <div className="overflow-x-auto">
            ...
            {historial.length === 0 && (
              <div className="text-gray-500 mt-4">No hay historial registrado para este curso.</div>
            )}
          </div>
        )}
      </div>
